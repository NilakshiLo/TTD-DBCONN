...
addCustomer  = "insert into Customer (Name, Address, Phone, Email, AADHAR, IDPROOF) values (?, ?, ?, ?, ?, ?)"
	...
	boolean updateCustomer(Customer c)throws Exception{
		if(DBConnection.getConnection()==null) 
			DBConnection.connect();
	...
	boolean deleteCustomer (Customer c)throws Exception{
	...
	ArrayList<Customer> showCustomerList() throws Exception{
