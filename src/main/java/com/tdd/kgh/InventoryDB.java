...
*/
	...
	boolean addInventory(Inventory i)throws Exception{
	...
	boolean updateInventory(Inventory i)throws Exception{
		if(DBConnection.getConnection()==null) 
			DBConnection.connect();
	...
	boolean deleteInventory(Inventory i)throws Exception{
	...
	ArrayList<Inventory> showInventoryList() throws Exception{
